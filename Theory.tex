...
\begin{equation}
  \begin{aligned}
     \atan x + \atan y
       &= \atan\left( \tan( \atan x + \atan y ) \right) \\
...
\begin{equation*}
  \begin{aligned}
    & 8 \atan \tfrac{1}{10}  \\
       &\quad= 4 \atan \frac{2(\sfrac{1}{10})}{1 - (\sfrac{1}{10})^2}
         \quad= 4 \atan \tfrac{20}{99} \\
       &\quad= 2 \atan \frac{2(\sfrac{20}{99})}{1 - (\sfrac{20}{99})^2}
         \quad= 2 \atan \tfrac{3960}{9401} \\
       &\quad= \atan \frac{2(\sfrac{3960}{9401})}{1 - (\sfrac{3960}{9401})^2}
...
\begin{equation*}
  \begin{aligned}
    & 4 \atan \tfrac{1}{515} \\
      &\quad= 2 \atan \frac{2(\sfrac{1}{515})}{1 - (\sfrac{1}{515})^2}
        \quad= 2 \atan \tfrac{515}{132612} \\
      &\quad= \atan \frac{2(\sfrac{515}{132612})}{1 - (\sfrac{515}{132612})^2}
...
\begin{equation}\label{function-f}
  f(x, n) = \frac{x^{2n+1}}{2n+1}
            \quad  [|x| \le 1]
\end{equation}
Then the Taylor-Maclaurin series for $\atan x$ (over $|x| \le 1$)
can be written as:
\begin{equation*}
...
Thus for $\atan x$, provided that $0 \le x \le 1$,
...
(i.e., $0 < x \le 1$, or $1 \le \sfrac{1}{x}$)
and assume that $a=\sfrac{1}{x}$ is the worst-case choice
...
\begin{equation*}
  f(\sfrac{1}{a}, \sfrac{R}{2}) < B^{-D}
\end{equation*}
Solving for $D$ yields:
\begin{equation*}
  D < \frac{ -\log f(\sfrac{1}{a}, \sfrac{R}{2}) }{ \log B }
\end{equation*}
...
\begin{equation}
  D
  < \frac{ -\log \frac{a^{-(2(\sfrac{R}{2})+1)}}{2(\sfrac{R}{2})+1} }{ \log B}
...
\begin{itemize}
  ...
  \item Hence it is okay to drop the $\log_{10}(R+1)$ term
    ...
    $\Imax = 2^{64}$ and $B=10$,
    which will give a fairly large $R=\tfrac{\Imax}{B+1}$,
...
and so $\texttt{BASE}$ in the code below
